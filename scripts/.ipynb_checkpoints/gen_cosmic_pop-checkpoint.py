...
def run_COSMIC(N_stars_desired, n_samples=int(1e6)):
    ...
    print("scaled COSMIC outputs to generat %i stars"%N_stars)
...
if __name__ == '__main__':
    ...
    # print("length of primary masses", len(m1s))
    m2s = secondary_masses.to(u.Msun).value
    # print("length of secondary masses", len(m2s))
    mtots = Mtots.to(u.Msun).value
    # print("length of Mtots", len(mtots))
    all_cms = all_CMs.to(u.Msun).value
    # print("length of all cms", len(all_cms))
    # print("implying length of singles", len(all_cms)-len(mtots))
