...
path0 = ph+"optimize_dense_sims_testing/0_circ_rvir0.75_lm/"
path1 = ph+"optimize_dense_sims_testing/1_circ_rvir0.75_hm/"
...
path8 = ph+"optimize_dense_sims_testing/8_gd1_rvir0.75_lm/"
path9 = ph+"optimize_dense_sims_testing/9_gd1_rvir0.75_hm/"
...
path16 = ph+"optimize_dense_sims_testing/16_pal5_rvir0.75_lm/"
path17 = ph+"optimize_dense_sims_testing/17_pal5_rvir0.75_hm/"
...
if __name__=="__main__":
    ...
    # parser.add_argument("--path_in", type=str, default= NEVERMIND
    parser.add_argument("--sim_n", type=int, default=0)
    parser.add_argument("--start", type=int, default=0)
    parser.add_argument("--stop", type=int, default=10000)
    parser.add_argument("--step", type=int, default=1)
    parser.add_argument("--save_to", type=str,
                        default="/n/netscratch/conroy_lab/Lab/amphillips/small_grid/structural_evolution_npzs/")
    ...
    print("computing structure @ each timestep")
    hmrs, nbounds, mass_bounds, t_rhs, t_dis = paf.compute_cluster_structure(path,
                                                                            i_list, 
                                                                            init_displacement,
                                                                            save=False)
